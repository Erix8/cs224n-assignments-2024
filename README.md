...
Each assignment folder has its own README with full setup + run instructions, plus its own conda
env file (`env.yml` for a1, `local_env.yml` for a2, `env-cpu.yml`/`env-gpu.yml` for a3, …).
